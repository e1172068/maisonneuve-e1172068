...
<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ $active == 'index' ? 'active' : '' }}" aria-current="page" href="{{ route('etudiant.index') }}">Liste des étudiants</a>
                </li>
                <li class="nav-item">
                <a class="nav-link {{ $active == 'create' ? 'active' : '' }}" href="{{ route('etudiant.create') }}">Ajouter un étudiant</a>
                </li>
            </ul>
        </div>
    </div>
